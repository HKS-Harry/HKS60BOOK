...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d");l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var p=m.getImageData(0,0,l.width,l.height),q=p.data,z=c?e(c):null,u=d?e(d):{r:0,g:0,b:0,a:0},r=0;r<q.length;r+=4){var v=q[r+3];0===v?(q[r]=u.r,q[r+1]=u.g,q[r+2]=u.b,q[r+3]=void 0!==u.a?u.a:0):0<v&&255>v?z&&(q[r]=Math.round((z.r*v+u.r*(255-v))/255),q[r+1]=Math.round((z.g*v+u.g*(255-v))/255),q[r+2]=Math.round((z.b*v+u.b*(255-v))/255),q[r+3]=255):z&&(q[r]=z.r,
...
var VERSION_NAME="7.0.0",BUILD_DATE="2025102710",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
Math.sqrt(W+y*y),!(1<=y)){y=2*y*y*y-3*y*y+1;var U=4*(T+M*f);H+=y*q[U+3];G+=y;255>q[U+3]&&(y=y*q[U+3]/250);F+=y*q[U];O+=y*q[U+1];L+=y*q[U+2];A+=y}}u[x]=F/A;u[x+1]=O/A;u[x+2]=L/A;u[x+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(z,0,0)}
